...
HD_PWD='/media/psf/TAUV-Playground/zybo-z7-tdoa/ip_repo/axi_fsk_demod/axi_fsk_demod.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_fsk_demod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_fsk_demod.tcl

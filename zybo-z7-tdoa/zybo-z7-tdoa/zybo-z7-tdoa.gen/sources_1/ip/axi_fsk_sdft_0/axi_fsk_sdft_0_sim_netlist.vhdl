...
--               /media/psf/TAUV-Playground/zybo-z7-tdoa/zybo-z7-tdoa/zybo-z7-tdoa.gen/sources_1/ip/axi_fsk_sdft_0/axi_fsk_sdft_0_sim_netlist.vhdl
...
entity axi_fsk_sdft_0_axi_fsk_sdft_v1_0 is
  port (
  ...
  attribute ORIG_REF_NAME of axi_fsk_sdft_0_axi_fsk_sdft_v1_0 : entity is "axi_fsk_sdft_v1_0";
end axi_fsk_sdft_0_axi_fsk_sdft_v1_0;

architecture STRUCTURE of axi_fsk_sdft_0_axi_fsk_sdft_v1_0 is
...
entity axi_fsk_sdft_0 is
  ...
  attribute NotValidForBitStream of axi_fsk_sdft_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of axi_fsk_sdft_0 : entity is "axi_fsk_sdft_0,axi_fsk_sdft_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of axi_fsk_sdft_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of axi_fsk_sdft_0 : entity is "axi_fsk_sdft_v1_0,Vivado 2022.2";
end axi_fsk_sdft_0;

architecture STRUCTURE of axi_fsk_sdft_0 is
  signal \<const0>\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of i_axis_clk : signal is "xilinx.com:signal:clock:1.0 i_axis_clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of i_axis_clk : signal is "XIL_INTERFACENAME i_axis_clk, ASSOCIATED_RESET i_axis_rst, ASSOCIATED_BUSIF AXIS_IN:AXIS_OUT, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of i_axis_in_tdata : signal is "XIL_INTERFACENAME AXIS_IN, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of o_axis_out_tdata : signal is "xilinx.com:interface:axis:1.0 AXIS_OUT TDATA";
  attribute X_INTERFACE_PARAMETER of o_axis_out_tdata : signal is "XIL_INTERFACENAME AXIS_OUT, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, LAYERED_METADATA undef, INSERT_VIP 0";
begin
...
inst: entity work.axi_fsk_sdft_0_axi_fsk_sdft_v1_0
     port map (

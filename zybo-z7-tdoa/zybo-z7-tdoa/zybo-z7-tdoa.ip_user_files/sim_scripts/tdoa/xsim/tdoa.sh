...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tdoa xil_defaultlib.tdoa xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  tdoa -key {Behavioral:sim_1:Functional:tdoa} -tclbatch cmd.tcl -protoinst "protoinst_files/tdoa.protoinst" -log simulate.log
}

...
HD_PWD='/media/psf/TAUV-Playground/zybo-z7-tdoa/zybo-z7-tdoa/zybo-z7-tdoa.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tdoa.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tdoa.tcl -notrace

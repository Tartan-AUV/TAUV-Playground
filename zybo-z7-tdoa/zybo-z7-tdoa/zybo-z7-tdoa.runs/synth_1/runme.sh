...
HD_PWD='/media/psf/TAUV-Playground/zybo-z7-tdoa/zybo-z7-tdoa/zybo-z7-tdoa.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tdoa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tdoa.tcl
